...
//---------------- DOCENTE
        ...
        docente.addAreasDeEspeciializacion("Masterado");
        docente.addAreasDeEspeciializacion("Licenciatura");
...
//---------------- INSTITUCION
        ...
        institucion1.addDireccion(TipoDireccion.INSTITUCION,"2 - Calle 1","2 - Calle 2", "002","Cuenca", "Azuay","Ecuador");
        ...
        institucion1.addAsignacion(asignacionAdministrativo);
        institucion1.addAsignacion(asignacionVisitante);
